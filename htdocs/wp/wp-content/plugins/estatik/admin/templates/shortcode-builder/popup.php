...
<div id="shortcode-builder-popup" class="white-popup">
    <form class="js-es-shortcode-builder-form" data-editor="<?php echo esc_attr( $_GET['context'] ); ?>">
        ...
        <div class="es-shortcode-builder__buttons">
            ...
            <input type="submit" value="<?php _e( 'Generate Shortcode', 'es-plugin' ); ?>" data-editor="<?php echo esc_attr( $_GET['context'] ); ?>" class="js-insert-shortcode hidden es-button es-button-green"/>
        </div>
    </form>
</div>