module.exports = function(grunt) {
        ...
        grunt.initConfig({
            ...
            concat: require('./grunt/multi-tasks/concat'),
        ...
        grunt.registerTask('default',['sass:plugin','postcss:plugin','cssmin:plugin','jshint:src','jshint:modules','concat:scripts','uglify:scripts']); // default
        grunt.registerTask('plugin',['sass:plugin','postcss:plugin','cssmin:plugin']); // plugin styles
        grunt.registerTask('scripts',['jshint:src','concat:scripts','uglify:scripts']); // scripts
