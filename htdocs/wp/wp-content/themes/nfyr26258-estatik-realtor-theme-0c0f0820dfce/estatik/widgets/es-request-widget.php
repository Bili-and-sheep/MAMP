...
echo $args['before_widget']; ?>
	...
	<div class="es-request-widget-wrap">
		...
		<?php if ( $es_property && ( class_exists( 'Es_Agent' ) && ( $agent = $es_property->get_agent() ) ) ) : ?>
		...
		<form action="" method="POST">
			...
			<div class="form-group ert-form-group">
				<input type="email" name="email" class="form-control ert-control" id="request-form-email" placeholder="<?php _e( 'Your Email', 'es-plugin' ); ?>" required/>
			</div>

			<?php if ( ! $disable_tel ) : ?>
				<div class="form-group ert-form-group">
					<input type="tel" name="tel" class="form-control ert-control" id="request-form-tel" placeholder="<?php _e( 'Phone number', 'es-plugin' ); ?>" required/>
				</div>
			<?php endif; ?>
			...
			<?php if ( $es_settings->privacy_policy_checkbox == 'required' ) : ?>
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="agree_terms-checkbox"><?php printf( __( 'I agree to the %s and %s', 'esm' ), $terms_of_use, $privacy_policy ); ?></label>
                </div>
			<?php endif; ?>
            ...
            <div class="text-right">
			    <input type="submit" class="btn btn-light" value="<?php _e( 'Send a message', 'es-plugin' ); ?>"/>
            </div>
