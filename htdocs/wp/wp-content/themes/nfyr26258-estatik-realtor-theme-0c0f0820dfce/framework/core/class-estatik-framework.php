...
class Estatik_Framework {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'ef-tabs', get_stylesheet_directory_uri() . '/framework/assets/js/tabs.jquery.js', array( 'jquery' ) );
		wp_register_script( 'ef-tooltipster-script', get_stylesheet_directory_uri() . '/framework/assets/js/tooltipster.bundle.min.js', array ( 'jquery' ) );
		wp_enqueue_script( 'ef-framework', get_stylesheet_directory_uri() . '/framework/assets/js/framework.jquery.js', array( 'jquery', 'ef-tooltipster-script', 'wp-color-picker', 'ef-select2-script' ) );
		wp_register_style( 'ef-lineawesome', 'https://maxcdn.icons8.com/fonts/line-awesome/1.1/css/line-awesome-font-awesome.min.css' );

		wp_enqueue_style( 'ef-tooltipster-style', get_stylesheet_directory_uri() . '/framework/assets/css/tooltipster.bundle.min.css' );
		wp_enqueue_style( 'ef-framework-style', get_stylesheet_directory_uri() . '/framework/assets/css/framework.css' );
